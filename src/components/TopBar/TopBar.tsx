            ...
            <div className="flex items-center justify-between gap-10"> 
                ...
                <div className="text-white ">
                    <a href="authentification">
                        ...
                        />
                        <img className="w-2 h-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjKU8YDosyoTjWVSrMGvkVLFbrx2Xyn4qPrg&s"/>
                    </a>
                </div>
                }
